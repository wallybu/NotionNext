...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Wally的认知笔记', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个专注分享搞钱信息的博客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.wallybu.top', // 网站地址
